...
begin
  ...
  begin
    ...
    RegisterMethod('function EnsureOriginalItemVisible(AnOriginalIndex: Integer): Integer');
    RegisterMethod('procedure CollapseAll');
    RegisterMethod('procedure CollapseItem(Index: Integer)');
    RegisterMethod('procedure CollapseOriginalItem(AnOriginalIndex: Integer)');
    ...
    RegisterProperty('OriginalCaption', 'string Integer', iptrw);
